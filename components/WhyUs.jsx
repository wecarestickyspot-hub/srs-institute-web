  ...
  return (
    <section id="why-us">
      <div className="section-header">
        <div className="section-overline">Our Advantage</div>
        <h2 className="section-title">Why Choose SRS Institute?</h2>
        <div className="gold-rule"></div>
      </div>
      <div className="why-grid">
        <div className="why-card"><div className="why-icon">👨‍🏫</div><div className="why-title">Expert Faculty</div><div className="why-desc">Experienced trainers with industry knowledge and hands-on teaching approach</div></div>
