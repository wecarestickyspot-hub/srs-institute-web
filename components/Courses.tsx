...
const courses: Course[] = [
  { icon: "🌐", name: "Web Design", desc: "HTML, CSS, JavaScript, responsive modern UI design", pill: "Beginner", pillColor: pillColors["Beginner"], duration: "3 Months", level: 1 },
  { icon: "💻", name: "Web Development", desc: "HTML, CSS, JavaScript, PHP, Wordpress, Bootstrap & live projects", pill: "Intermediate", pillColor: pillColors["Intermediate"], duration: "5-6 Months", level: 2 },
  { icon: "📊", name: "Data Analyst", desc: "Advanced Excel,Python, SQL, Power BI, visualization & reporting", pill: "Career", pillColor: pillColors["Career"], duration: "5-6 Months", level: 2 },
  { icon: "🧾", name: "Tally / ERP with GST", desc: "Accounting, Excel GST filing, billing & inventory", pill: "Job Ready", pillColor: pillColors["Job Ready"], duration: "2-3 Months", level: 1 },
  { icon: "🏗️", name: "Full Stack Dev", desc: "Frontend & Backend JavaScript, React & APIs, deployment & DevOps", pill: "Advanced", pillColor: pillColors["Advanced"], duration: "7-8 Months", level: 3 },
  { icon: "🎨", name: "UI / UX Design", desc: "Photoshop, Illustrator, Figma, Adobe XD, Sketch, Projects ", pill: "Creative", pillColor: pillColors["Creative"], duration: "6-12 Months", level: 2 },
  { icon: "🤖", name: "Artificial Intelligence", desc: "ML basics, AI tools, prompt engineering", pill: "Future Tech", pillColor: pillColors["Future Tech"], duration: "5-6 Months", level: 3 },
  { icon: "🧊", name: "3D Designing", desc: "Blender, 3D modeling, rendering & animation", pill: "Creative", pillColor: pillColors["Creative"], duration: "4-5 Months", level: 2 },
  { icon: "🎬", name: "Graphic", desc: "Coral Draw, Photoshop, Illustrator, Canva", pill: "Creative", pillColor: pillColors["Creative"], duration: "6-12 Months", level: 1 },
  { icon: "🎥", name: "Video Editing", desc: "Premiere Pro, After Effects, Capcut & editing techniques", pill: "Intermediate", pillColor: pillColors["Intermediate"], duration: "6-12 Months", level: 2 },
  { icon: "📢", name: "Digital Marketing", desc: "SEO, Google Ads, Facebook Ads, Google Analytics, Mailchimp, Canva & social media campaigns", pill: "Marketing", pillColor: pillColors["Marketing"], duration: "4-5 Months", level: 2 },
  { icon: "📐", name: "AutoCAD", desc: "AutoCad, Architecture, SketchUp, & 3dx MAx & architecture plans", pill: "Engineering", pillColor: pillColors["Engineering"], duration: "6-12 Months", level: 2 },
  { icon: "🏛️", name: "Architecture", desc: "SketchUp, V-Ray/Lumion, Rvit & 3dx MAx(Advanced Visualization)", pill: "Professional", pillColor: pillColors["Professional"], duration: "6-12 Months", level: 2 },
  ...
  { icon: "🔬", name: "Data Science", desc: "AI, Statistics, SQL, Power BI, Python, ML models, Deep Learning & projects", pill: "Advanced", pillColor: pillColors["Advanced"], duration: "12-13 Months", level: 3 },
  {
    icon: "🛡️",
    name: "Cyber Security",
    desc: "Ethical Hacking, Network Security, Penetration Testing, Web Security, Digital Forensics, Malware Analysis, Cloud Security, SOC Operations & Incident Response",
    pill: "Advanced",
    pillColor: pillColors["Advanced"],
    duration: "12-13 Months",
    level: 3
  },
  { icon: "⚙️", name: "CNC Design", desc: "Photoshop, AutoCAD, Fusion 360, ArtCAM", pill: "Intermediate", pillColor: pillColors["Intermediate"], duration: "6-12 Months", level: 2 },
];
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{ textAlign: "center" }}>
              ...
              <div style={{
                fontSize: "0.68rem", color: "#a0a0a0", letterSpacing: "1px",
