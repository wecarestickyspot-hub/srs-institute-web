...
const courses: Course[] = [
  ...
  { icon:"📊", name:"Data Analyst",           desc:"Python, Excel, visualization & reporting",            pill:"Career",       pillColor:pillColors["Career"],       duration:"5-6 Months",  level:2 },
  { icon:"🧾", name:"Tally / ERP with GST",   desc:"Accounting, GST filing, billing & inventory",        pill:"Job Ready",    pillColor:pillColors["Job Ready"],    duration:"1-2 Months",  level:1 },
  { icon:"🏗️", name:"Full Stack Dev",         desc:"MERN stack, APIs, deployment & DevOps",              pill:"Advanced",     pillColor:pillColors["Advanced"],     duration:"7-8 Months",  level:3 },
  { icon:"🎨", name:"UI / UX Design",         desc:"Figma, wireframes, user research & testing",         pill:"Creative",     pillColor:pillColors["Creative"],     duration:"5-6 Months",  level:2 },
  ...
  { icon:"💰", name:"Accounting Professional",desc:"Financial accounting, tax & audit basics",            pill:"Finance",      pillColor:pillColors["Finance"],      duration:"5-6 Months",  level:2 },
